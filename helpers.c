...
void blur(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for (int i = 0; i < height; i++)
    {
        for (int j = 0; j < width; j++)
        {
            ...
            blurredImage[i][j].rgbtRed = totalRed / neighbor_count;
            blurredImage[i][j].rgbtGreen = totalGreen / neighbor_count;
            blurredImage[i][j].rgbtBlue = totalBlue / neighbor_count;
        }
    }
    for (int i = 0; i < height; i++)
    {
